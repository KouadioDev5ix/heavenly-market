    ...
    <div>
      <div>
        ...
        <span className="text-sm font-semibold text-black">
          Toutes categories {">"} T-short {">"} Original lorem ipsum{" "}
        </span>
      </div>
            ...
            detailArtircle?.category === "women's clothing" ? (
              <div>
                ...
                <div>
                  ...
                  <div className="flex gap-2 my-2">
                    <button className="border px-4 py-2 rounded-md">S</button>
                    <button className="border px-4 py-2 rounded-md bg-black text-white">
                      M
                    </button>
                    <button className="border px-4 py-2 rounded-md">L</button>
                    <button className="border px-4 py-2 rounded-md">XL</button>
                  </div>
                </div>
              </div>
            ) : null}
